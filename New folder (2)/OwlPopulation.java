...
public class OwlPopulation{
    ...
    public void populateData() throws FileNotFoundException{
        ...
        while (scanner.hasNextLine()) {
            ...
            Owl object=new Owl(temp[0],Integer.parseInt(temp[1]),Double.parseDouble(temp[2]));
            data[index]=object;
            index++;
        }
        scanner.close();
    ...
    public Owl getHeaviest(){
        ...
        double heaviestWeight = Double.parseDouble(heaviestOwl.getWeight());
        double currentWeight = Double.parseDouble(data[numberOfOwls].getWeight());
        while(numberOfOwls < data.length){
            if (heaviestWeight<currentWeight){
                heaviestOwl= data[numberOfOwls];
            }
            numberOfOwls++;
        ...
        public String toString() {
            ...
            return "Summary of Population:\n" +
                    "Youngest Owl: " + youngest.getName() + " Age: " + youngest.getAge() + "\n" +
                    "Heaviest Owl: " + heaviest.getName() + " Age: " + heaviest.getAge() + "\n" +
                    "Average Age: " + avgAge;
        }
    ...
    public static void main(String[] args) {
       Owl object=new Owl(null, 0, 0);
       Owl owl2=new Owl("Rag", 2, 2);
       Owl owl1=new Owl("Rag",2,2);
       
       System.out.print(object.Equals(owl1,owl2));
    ...
    try {
        OwlPopulation pop1 = new OwlPopulation("C:\\Users\\user\\Downloads\\Poppulation\\owlPopulation1.csv");
        OwlPopulation pop2 = new OwlPopulation("C:\\Users\\user\\Downloads\\Poppulation\\owlPopulation2.csv");
        ...
        pop2.populateData();
          ...
          System.out.print(pop2.toString());
